...
- [PR Radar](https://github.com/deployhq/pr-radar) Browser extension that surfaces a unified review dashboard across GitHub, GitLab, and Bitbucket pull requests — CI status, unresolved comments, review state, and notifications, without keeping a tab open.
