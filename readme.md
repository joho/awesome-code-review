...
- [BattleTest](https://battletest.dev) AI code review for pull requests that flags secrets, injection, auth flaws and vulnerable dependencies, reasoning about whether the change is actually exploitable rather than pattern-matching. Free on public repos.
