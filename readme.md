...
- [An experiment to assess the cost-benefits of code inspections in large scale software development (Porter, Siy, Toman and Votta, 1997)](http://laser.cs.umass.edu/courses/cs521-621.Fall10/documents/PorterSiyetal.pdf) Early paper that tested a range of then-current review techniques including multi-stage review and code-review-via-meeting that found you can get most of the benefit in an offline, single pass, with two reviewers.
- [Anywhere, anytime code inspections: using the Web to remove inspection bottlenecks in large-scale software development (Perpich, Perry, Porter, Votta and Wade, 1997)](https://dl.acm.org/citation.cfm?id=253234) One day in the far future the best way to review code will be on the world wide web.
...
- [Helping Developers Help Themselves: Automatic Decomposition of Code Review Changes (Barnett et al. 2015)](http://research.microsoft.com/pubs/238937/barnett2015hdh.pdf) - Research into automatically splitting big diffs into smaller diffs leading to better reviews.
...
- [Work Practices and Challenges in Pull-Based Development (Gousios et al. 2015)](https://sback.it/publications/icse2016b.pdf) Field study of how GitHub pull requests are used in the wild.
...
- [Brian Guthrie Feature Branching Rant](https://twitter.com/bguthrie/status/937750796334174209) Twitter thread on the pros and cons of GitHub open source first model with regards to in-company code review practice.
...
- [Code Review Review is the Manager Job](https://hecate.co/blog/code-review-review-is-the-managers-job) Why management should ensure code review is done and done well.
...
- [How to do a code review](https://google.github.io/eng-practices/review/reviewer/) A thorough description of how Google engineers do code reviews, from Google Engineering Practices documentation.
...
- [Modern Code Reviews](https://rethought.se/research/modern-code-reviews/) Arguably belongs in academic paper, but a website giving an overview of evidence on code review.
...
- [Ship Small Diffs](https://blog.skyliner.io/ship-small-diffs-741308bec0d1) Why it is better to review small changes rather than large ones.
...
- [Best Kept Secrets of Peer Code Review](https://www.goodreads.com/book/show/1563457.Best_Kept_Secrets_of_Peer_Code_Review) Older compilation of 10 essays on the practice of code reviews.
...
- [Crucible](https://www.atlassian.com/software/crucible) Atlassian on-premise code review tool.
...
- [Independent Review Toolkit](https://github.com/redamancy231-create/independent-review-toolkit) - Multi-model independent review SOP, prompt templates, and adversarial challenge framework for bias-resistant code review.
...
- [Softagram](https://softagram.com/) Automated code change visualization for pull requests, merge requests and patch sets.
...
- [Upsource](https://www.jetbrains.com/upsource/) JetBrain on-premise git/mercurial/perforce/svn code review tool.
