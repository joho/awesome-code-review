...
- [prpack](https://github.com/Lucas2944/prpack) Open-source CLI that packs a pull request (diff plus full post-change file contents) into a single markdown file for LLM code review.
