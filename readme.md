...
- [AI Code Detector](https://ismycodeai.com) Browser-based heuristic that highlights configured code-style signals and matching lines; it does not determine authorship.
