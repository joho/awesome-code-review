...
- [CodeHawk](https://codehawk.crossgen-ai.com) GitHub App that reviews pull requests automatically and posts inline comments on bugs, security vulnerabilities, and logic errors.
