...
- [Disensor](https://github.com/NicolasRocchia/disensor) Open source CI gate for adversarial AI review: validates and enforces a declaration of what the review could not close.
