...
- [Sebastion AI](https://foundationmachines.ai) Security-first AI code reviewer for GitHub pull requests. Inline CWE-tagged findings, OSV-backed dependency checks, autofix on Pro. Free for public repos.
