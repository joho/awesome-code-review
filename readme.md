...
- [Bubo](https://github.com/mountainowl/bubo) Self-hosted AI code reviewer for GitHub pull requests and GitLab merge requests that posts evidence-backed inline findings and learns from repository feedback.
