...
- [PR Cockpit](https://prcockpit.com) Desktop app for reviewing GitHub pull requests that opens a pull request in about 20 ms at p50; keyboard-first, with a CLI for coding agents.
