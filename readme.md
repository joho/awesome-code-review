...
- [PR Risk Labeler](https://github.com/abyworkings-coder/pr-risk-labeler) GitHub Action that labels pull requests by size and by whether they touch configurable critical paths (infra, migrations, payments), posting a reviewer checklist comment.
