...
- [Sverklo](https://github.com/sverklo/sverklo) Local-first code intelligence MCP server with diff-aware PR review, blast-radius analysis, and semantic code search across 10 languages.
