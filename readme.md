...
- [Code Reviews: Honesty, Kindness, Inspiration: Pick Three - Jacob Stoebel RubyConf 2017](https://www.youtube.com/watch?v=hP_2XKYia9I) How to do effective code review while remaining kind to the original author.
- [Goldilocks and the Three Code Reviews - Vaidehi Joshi RedDot Ruby Conf 2017](https://www.youtube.com/watch?v=-6EzycFNwzY) Finding just the right amount of code review by focussing on what is affecting.
