...
- [SPARDA](https://github.com/zyx77550/sparda-skills) Connects AI coding agents to the SPARDA Security Gate. Validates agent edits against runtime invariants before applying them (Proof-Carrying Code for Agents).
