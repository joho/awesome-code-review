...
- [Tendril](https://tendril.ivy.app) Open-source AI coding orchestrator with automated code review gates that verify implementation matches plan intent before code reaches human review.
